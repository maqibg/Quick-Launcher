...
const en: Dictionary = {
  ...
  "settings.maskOpacity.card": "Card mask opacity",
  "settings.maskOpacity.control": "Control mask opacity",
  "settings.maskOpacity.reset": "Reset",
...
const zhCN: Dictionary = {
  ...
  "settings.maskOpacity.card": "卡片遮罩不透明度",
  "settings.maskOpacity.control": "控件遮罩不透明度",
  "settings.maskOpacity.reset": "重置",
